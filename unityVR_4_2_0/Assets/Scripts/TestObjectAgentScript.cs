...
public class TestObjectAgentScript : AgentScript {
	...
	{	
		...
		if (MySimpleNet != null) 
		{
			MySimpleNet.Send (new MsgActionExecutationStatus () {actionID = MovementIDExecuting, status = MsgActionExecutationStatus.InExecution});
		}
	...
	{	
		...
		{	
			if (MySimpleNet != null) 
			{
				MySimpleNet.Send (new MsgActionExecutationStatus () {actionID = MovementIDExecuting, status = MsgActionExecutationStatus.Rotating});
			}
			...
			if (MySimpleNet != null) 
			{
				MySimpleNet.Send (new MsgActionExecutationStatus () {actionID = MovementIDExecuting, status = MsgActionExecutationStatus.WalkingRotating});
			}
